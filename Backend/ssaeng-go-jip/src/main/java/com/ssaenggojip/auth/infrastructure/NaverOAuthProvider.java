...
public class NaverOAuthProvider {
    ...
    public NaverUserInfo getUserInfo(String code) {
        ...
        log.info("NaverOAuthProvider.getUserInfo response={}", response.getBody());
    ...
    private String fetchAccessToken(String code) {
        ...
        ResponseEntity<NaverAccessTokenResponse> response = restTemplate.exchange(
                tokenUri,
                HttpMethod.POST,
                requestEntity,
        ...
        log.info("NaverOAuthProvider.fetchAccessToken response={}", response.getBody());
    ...
    @Getter
    @ToString
    public static class NaverAccessTokenResponse {
