...
public class SsafyOAuthProvider {
    ...
    public SsafyUserInfo getUserInfo(String code) {
        ...
        log.info("SsafyAuthProvider.getUserInfo response={}", response.getBody());
    ...
    private String fetchAccessToken(String code) {
        ...
        ResponseEntity<SsafyAccessTokenResponse> response = restTemplate.exchange(
                tokenUri,
                HttpMethod.POST,
                requestEntity,
                SsafyAccessTokenResponse.class
        );

        log.info("SsafyOAuthProvider.fetchAccessToken response={}", response.getBody());
    ...
    @Getter
    @ToString
    public static class SsafyAccessTokenResponse {
