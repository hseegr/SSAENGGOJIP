...
const DetailInfo: React.FC = () => {
  ...
  return (
    <div className="w-[400px] h-full bg-white border-l border-gray-300 p-4 overflow-y-auto">
      {/* 방 종류 + 닫기 버튼 */}
      ...
      <div className="flex items-center mb-4">
        <h2 className="text-xl font-bold pr-3">{propertyData.dealType} {propertyData.price}</h2>
        <p className="text-sm">관리비 {propertyData.rentPrice}만원</p>
      </div>
