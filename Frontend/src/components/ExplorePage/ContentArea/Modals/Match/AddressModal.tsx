      ...
      <div className="relative bg-white rounded-xl shadow-2xl w-[420px] h-[588px] max-w-md max-h-[90vh]  p-6 flex flex-col">
        <div className="overflow-y-auto">
          ...
          <div className="flex justify-between mb-3 px-3">
            ...
            <div className="mt-6">
              <button
                className="text-ssaeng-purple text-sm font-normal mt-4 mb-1 mr-2 py-1 px-4 border border-ssaeng-purple rounded-md hover:bg-ssaeng-gray-3"
                  ...
                  <div key={info.id} className="px-3 mb-4">
                    ...
                    <div className="flex items-start gap-2">
                      ...
                      <div className="flex-1 p-4 rounded-lg bg-ssaeng-gray-1 border border-ssaeng-gray-2">
                        ...
                        {/* 기본 주소 여부 섹션 */}
                        {/* <div className="mt-2 text-xs font-medium text-gray-700 flex items-center justify-center">
                      기본 주소 여부:{' '}
                      <div className="">
                        {info.isDefault ? (
                          <div className="ml-2 bg-ssaeng-purple text-white py-2 px-20 rounded-md text-xs font-semibold">
                            예
                          </div>
                        ) : (
                          <div className="ml-2 bg-ssaeng-purple text-white py-2 px-20 rounded-md text-xs font-semibold">
          ...
          {/* 완료 버튼 */}
          {!isEditMode && (
            <div className="sticky bottom- left-0 right-0 bg-white mt-auto z-10 p-2">
              <button
